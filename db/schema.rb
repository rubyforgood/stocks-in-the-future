...
ActiveRecord::Schema[8.0].define(version: 20_250_608_160_040) do
  ...
  create_table 'portfolio_stocks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[portfolio_id stock_id], name: 'index_portfolio_stocks_on_portfolio_and_stock'
  ...
  create_table 'school_years', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[school_id year_id], name: 'index_school_years_on_school_id_and_year_id', unique: true

...
ActiveRecord::Schema[8.1].define(version: 2026_08_10_170606) do
  ...
  create_table "quarters", force: :cascade do |t|
    ...
    t.integer "school_days", comment: "Teaching days in the quarter. Perfect attendance is derived from it."

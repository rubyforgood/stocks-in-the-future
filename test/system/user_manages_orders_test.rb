...
class UserManagesOrdersTest < ApplicationSystemTestCase
  test "creating a new order" do
    ...
    # TODO: Fix modal visibility - Ticket #7: Fix Order Management Interface
  ...
  # TODO: Fix failing test - Capybara::ElementNotFound: Unable to find field "Number of shares" that is not disabled
